...
namespace Fusion.UnityPhysics {
  ...
  public abstract partial class NetworkRigidbodyBase : NetworkTRSP, INetworkTRSPTeleport {
    ...
    protected bool           _hasInterpolationTarget;
    protected bool           _interpolationEnabled;
    ...
    public override void Spawned() {
      ...
      _interpolationEnabled = Runner.Mode != SimulationModes.Server;
    ...
    public abstract void MovingTeleport(Vector3? position = null, Quaternion? rotation = null);
  }
