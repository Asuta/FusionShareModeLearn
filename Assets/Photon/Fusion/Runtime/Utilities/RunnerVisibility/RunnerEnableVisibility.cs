...
namespace Fusion
{
  ...
  /// <summary>
  /// When running in Multi-Peer mode, this component automatically will register the associated <see cref="NetworkRunner"/> with <see cref="NetworkRunnerVisibilityExtensions"/>,
  ...
  public class RunnerEnableVisibility : Fusion.Behaviour, INetworkRunnerCallbacks
    {
      ...
      private void Awake() {
        ...
        if (TryGetComponent<NetworkRunner>(out var runner)) 
        {
          ...
          // Just a habit to be safe against double registration.
